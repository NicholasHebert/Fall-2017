...
function handleMouseDown(e) {
    ...
    if (wordBeingMoved != null) {
        ...
        document.getElementById("canvas1").mousemove(handleMouseMove);
        document.getElementById("canvas1").mouseup(handleMouseUp);
...
function handleMouseUp(e) {
    ...
    document.getElementById("canvas1").off("mousemove", handleMouseMove); //remove mouse move handler
    document.getElementById("canvas1").off("mouseup", handleMouseUp); //remove mouse up handler
...
function handleKeyUp(e) {
    ...
    if (e.which == ENTER) {
        ...
        document.getElementById('userTextField').val(''); //clear the user text field
    }
...
function handleSubmitButton() {
    ...
    if (userText && userText != '') {
        ...
        var xhr = new XMLHttpRequest(), method = "POST", url = "userText";
...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    document.addEventListener("canvas1", function(mousedown) {
        handleMouseDown();
    });
    ...
    document.addEventListener(document, function(keydown) {
        handleKeyDown();
    })
    document.addEventListener(document, function(keyup) {
        handleKeyUp();
    })
