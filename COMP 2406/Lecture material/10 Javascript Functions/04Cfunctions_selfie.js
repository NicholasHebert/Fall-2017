...
var lightbulb = (function () { 
	...
	getState = function getState() { return isOn }, 
	off = function off() { isOn = false; return isOn;}, 
	on = function on() { isOn = true; return isOn;}; 
	
	return { toggle: toggle, getState: getState, off: off, on: on };
