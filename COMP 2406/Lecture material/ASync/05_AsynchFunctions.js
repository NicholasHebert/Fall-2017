...
Option: Allow the callback functions to be passed in as a parameters
...
function read(callback1, callback2) {
  setTimeout(function(){console.log("read data");
             callback1(callback2);}, Math.floor((Math.random() * 1000) + 1));
}
