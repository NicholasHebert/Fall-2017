...
exports.find = function(request, response) {
    ...
    if (urlObj.query['recipe_name']) {//was title
        console.log("finding recipe name: " + urlObj.query['recipe_name']);
        sql = "SELECT id, title FROM recipes WHERE recipe_name LIKE '%" +
...
exports.recipeDetails = function(request, response) {
    ...
    var sql = "SELECT id, recipe_name, json FROM recipes WHERE id=" + recipeID;
